  ...
  return (
    <form onSubmit={handleSubmit} className="bg-[var(--secondary)] p-md text-[var(--textLight)] flex flex-col gap-sm">
		<div className="flex flex-row justify-between">
			...
			{status && <p className="text-sm text-[var(--accent)] self-end">{status}</p>}
		</div>
		...
		<div className="flex justify-between items-center">
			...
			<button
				type="submit"
				className="bg-[var(--primary)] text-[var(--secondary)] cursor-pointer px-4 py-1 hover:bg-[var(--accent)] text-sm"
				>Send
			</button>
		</div>
